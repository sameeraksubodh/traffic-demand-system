...
# --- PREMIUM TWO-COLUMN DASHBOARD UI LAYOUT ---
PREMIUM_UI = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Intelligent Traffic Dashboard</title>
    ...
    <style>
        ...
        .recommendation-box { border-left: 4px solid var(--primary); background: #eff6ff; border-radius: 0 12px 12px 0; padding: 16px; transition: all 0.3s ease; }
    </style>
</head>
<body class="py-4">
    <nav class="navbar navbar-light bg-white border-bottom mb-5">
        <div class="container">
            <span class="navbar-brand fw-bold">🚦 Innovexa Catalyst System</span>
            <span class="badge bg-success text-white px-3 py-2 rounded-pill">● Engine Live</span>
        </div>
    </nav>
    <div class="container">
        <div class="row g-4">
            ...
            <!-- Right Side Stacked Visual Metrics Output -->
            <div class="col-md-7">
                <div class="d-flex flex-column h-100 justify-content-between gap-3">
                    ...
                    <div class="card p-4">
                        <h6 class="fw-bold mb-2 text-dark">🧠 Smart Routing Recommendation</h6>
                        <div class="recommendation-box" id="recBox">
                            <p class="mb-0 text-secondary small font-weight-medium" id="routingOut">Waiting for operational execution...</p>
                        </div>
                    </div>
                </div>
            </div>
