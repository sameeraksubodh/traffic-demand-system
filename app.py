...
# --- HIGHLY ORGANIZED PREMIUM WEB LAYOUT ---
PREMIUM_UI = """
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container mb-5" style="max-width: 1140px;">
        <div class="row g-4">
            ...
            <!-- Right Layout Column (Outputs Matrix) -->
            <div class="col-lg-7">
                
                <!-- Main Core Metric Panel -->
                ...
                <!-- Secondary Sub-Metrics Analysis Panel -->
                <div class="card">
