# templates.py - Standalone Premium Dashboard Layout String
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-7">
                <div class="d-flex flex-column h-100 justify-content-between gap-4">
                    ...
                    <div class="card p-4">
                        <h6 class="fw-bold mb-3 d-flex align-items-center text-dark">
                            <span class="me-2 fs-5">🧠</span> Smart Routing Recommendation
                        </h6>
                        <div class="recommendation-box" id="recommendationContainer">
                            <p class="mb-0 text-secondary fw-medium fs-6" id="routingOut">
